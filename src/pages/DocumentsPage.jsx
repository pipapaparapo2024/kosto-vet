...
const AGREEMENT = {
  ...
  sections: [
    ...
    {
      id: 'vozvrat-i-obmen-tovara', num: 8, title: 'Возврат и обмен товара',
      paragraphs: [
        '8.1. Возврат товара надлежащего качества возможен в течение 7 дней с момента получения, если товар не был в употреблении, сохранены его товарный вид, потребительские свойства, пломбы и фабричные ярлыки.',
        '8.2. Для возврата или обмена свяжитесь с нами по телефону или email, указав номер заказа и причину возврата. Мы согласуем порядок и сроки.',
        '8.3. Стерилизованные и вскрытые медицинские изделия возврату и обмену не подлежат.',
        '8.4. В случае получения товара ненадлежащего качества Покупатель вправе потребовать замены или возврата денежных средств в полном объёме.',
      ],
    },
    {
      id: 'otvetstvennost-storon', num: 9, title: 'Ответственность сторон',
      paragraphs: [
        '9.1. Магазин не несёт ответственности за ущерб, возникший вследствие ненадлежащего использования товара, несоответствия способа применения показаниям, а также за действия третьих лиц.',
        '9.2. Ответственность Магазина ограничена стоимостью конкретного заказа.',
        '9.3. Покупатель самостоятельно несёт ответственность за правомерность применения изделий и соответствие их использования действующему законодательству.',
      ],
    },
    {
      id: 'intellektualnaya-sobstvennost', num: 10, title: 'Интеллектуальная собственность',
      paragraphs: [
        '10.1. Все материалы Сайта (тексты, фотографии, логотипы, дизайн) являются объектами интеллектуальной собственности Магазина или его партнёров.',
        '10.2. Использование материалов Сайта без письменного согласия правообладателя запрещено.',
      ],
    },
    {
      id: 'personalnye-dannye', num: 11, title: 'Персональные данные',
      paragraphs: [
        '11.1. Обработка персональных данных осуществляется в соответствии с Политикой конфиденциальности, размещённой на Сайте.',
        '11.2. Оформляя заказ или заполняя форму обратной связи, Вы даёте согласие на обработку персональных данных в целях исполнения заказа и улучшения качества обслуживания.',
        '11.3. Мы не передаём персональные данные третьим лицам, за исключением случаев, необходимых для исполнения заказа (службы доставки, платёжные системы).',
      ],
    },
    {
      id: 'zaklyuchitelnye-polozheniya', num: 12, title: 'Заключительные положения',
      paragraphs: [
        '12.1. Настоящее Соглашение вступает в силу с момента акцепта его условий Пользователем и действует до момента его расторжения.',
        '12.2. В случае возникновения споров стороны обязуются урегулировать их путём переговоров. При недостижении согласия споры рассматриваются в судебном порядке по месту нахождения Магазина.',
        '12.3. Признание какого-либо положения Соглашения недействительным не влечёт недействительности остальных положений.',
        '12.4. По всем вопросам обращайтесь: Kosto-Vet@yandex.ru или +7 (961) 189-89-33.',
      ],
    },
  ],
}
            ...
            {activeDoc && content ? (
              <>
                <div className={styles.docHeader}>
                  ...
                  <a
                    href="mailto:Kosto-Vet@yandex.ru?subject=Запрос документа"
                    className={styles.downloadBtn}
                    title="Запросить PDF по email"
                  >
